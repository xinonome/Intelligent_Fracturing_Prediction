...
Typical usage:
    python FSL-Expert\knowledge_graph\build_full_book_kg_with_qwen.py --max-pages 10
    python FSL-Expert\knowledge_graph\build_full_book_kg_with_qwen.py --pages-before 63
    python FSL-Expert\knowledge_graph\build_full_book_kg_with_qwen.py --include-images --pages-before 63
"""
